...
const Place: React.FC<PlaceI> = ({ element, map, setSelectedPlace }) => {
  ...
  return (
    <div
      onClick={() => handleClick()}
      className="relative flex-1 place-card before:duration-200 w-full h-28 before:flex before:items-center before:text-white before:text-xl before:font-bold before:justify-center before:content-['ZOBACZ_NA_MAPIE'] before:absolute before:h-28 before:w-full overflow-hidden before:translate-y-28 before:skew-y-[8deg] before:z-10 before:hover:skew-y-0 before:hover:translate-y-0 before:bg-primary-color  bg-back-color hover:cursor-pointer"
    >
      ...
      <div className="flex flex-row scale-90 md:scale-100 h-20 gap-4 md:gap-0 items-center justify-between px-4">
        ...
        <div className="rating flex flex-col items-center justify-center">
          <h2 className="text-md text-center">Opinie o miejscu</h2>
